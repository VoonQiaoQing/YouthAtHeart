        ...
        "columns": [
            ...
            { "data": "wsId", "name": "wsId" },
            {
                ...
                "render": function (data, row) {
                    ...
                    var countDownDate = new Date(data.regEndDate).getTime();
                    var distance;
                    ...
                    if (distance > 0) {
                        return '<div class="col-sm-12">' +
                            ...
                            '<a id="details" style="float: right;" class="btn btn-warning" href="/WorkshopListing/' + data.wsId + '/Details" >Details</a>' +
                            '</div>' +
                            '</div>' +
                            '</div>';
                    }
